// parallel_hps_single_pio_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module parallel_hps_single_pio_mm_interconnect_0 (
	...
	wire  [121:0] pio_0_s1_agent_rf_source_data;                         // pio_0_s1_agent:rf_source_data -> pio_0_s1_agent_rsp_fifo:in_data
	...
	wire  [121:0] pio_0_s1_agent_rsp_fifo_out_data;                      // pio_0_s1_agent_rsp_fifo:out_data -> pio_0_s1_agent:rf_sink_data
	...
	wire  [121:0] pio_1_s1_agent_rf_source_data;                         // pio_1_s1_agent:rf_source_data -> pio_1_s1_agent_rsp_fifo:in_data
	...
	wire  [121:0] pio_1_s1_agent_rsp_fifo_out_data;                      // pio_1_s1_agent_rsp_fifo:out_data -> pio_1_s1_agent:rf_sink_data
	...
	wire  [120:0] pio_0_s1_agent_rp_data;                                // pio_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [120:0] pio_1_s1_agent_rp_data;                                // pio_1_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [120:0] cmd_mux_src_data;                                      // cmd_mux:src_data -> pio_0_s1_burst_adapter:sink0_data
	...
	wire  [120:0] pio_0_s1_burst_adapter_source0_data;                   // pio_0_s1_burst_adapter:source0_data -> pio_0_s1_agent:cp_data
	...
	wire  [120:0] cmd_mux_001_src_data;                                  // cmd_mux_001:src_data -> pio_1_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                 // pio_1_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                               // cmd_mux_001:src_channel -> pio_1_s1_burst_adapter:sink0_channel
	...
	wire  [120:0] pio_1_s1_burst_adapter_source0_data;                   // pio_1_s1_burst_adapter:source0_data -> pio_1_s1_agent:cp_data
	wire          pio_1_s1_burst_adapter_source0_ready;                  // pio_1_s1_agent:cp_ready -> pio_1_s1_burst_adapter:source0_ready
	wire    [1:0] pio_1_s1_burst_adapter_source0_channel;                // pio_1_s1_burst_adapter:source0_channel -> pio_1_s1_agent:cp_channel
	...
	parallel_hps_single_pio_mm_interconnect_0_router router (
	...
	parallel_hps_single_pio_mm_interconnect_0_router router_001 (
	...
	parallel_hps_single_pio_mm_interconnect_0_router_002 router_002 (
	...
	parallel_hps_single_pio_mm_interconnect_0_router_002 router_003 (
	...
	parallel_hps_single_pio_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                    //        clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	parallel_hps_single_pio_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //        clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	parallel_hps_single_pio_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	parallel_hps_single_pio_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	parallel_hps_single_pio_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	parallel_hps_single_pio_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	parallel_hps_single_pio_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	parallel_hps_single_pio_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	parallel_hps_single_pio_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
