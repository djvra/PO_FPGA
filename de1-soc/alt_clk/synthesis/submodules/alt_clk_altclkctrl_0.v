...
module  alt_clk_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //alt_clk_altclkctrl_0_sub
...
`endif
    ...
    alt_clk_altclkctrl_0_sub  alt_clk_altclkctrl_0_sub_component (
                .ena (ena),
                .inclk (sub_wire2),
                .outclk (sub_wire0));
